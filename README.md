...
<div style="display: flex; flex-wrap: wrap;">
  <div style="margin: 10px; display: flex; flex-direction: column; align-items: center;">
    <img src="./assets/ProjectScreenShots/AppLoading.png" alt="AppLoading.png" width="200" style="margin-bottom: 5px;" />
    <p style="text-align: center;">App Loading</p>
  </div>
  <div style="margin: 10px; display: flex; flex-direction: column; align-items: center;">
    <img src="./assets/ProjectScreenShots/LoginScreen.png" alt="LoginScreen.png" width="200" style="margin-bottom: 5px;" />
    <p style="text-align: center;">Login Screen</p>
  </div>
  <!-- Diğer resimler ve metinleri buraya ekleyin -->
</div>
